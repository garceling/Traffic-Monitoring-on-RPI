...
def facial_processing():
    ...
    predictor   = dlib.shape_predictor('/home/pi/Desktop/Drowsiness_Detector/shape_predictor_68_face_landmarks.dat')
	...
	#convert frame to grayscale
		...
		#checks if the user is yawning for a sufficient number of frames
            ...
            #I added this here, if the user ever turns their head so that there eyes are no longer on the road
